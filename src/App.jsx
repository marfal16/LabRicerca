...
const researchProjects = [
  { title: "Identification of AIM2 as a new drug target in lung cancer", image: project1 },
  { title: "Fibrofarma – transcriptomic and proteomic profiling of patients with idiopathic pulmonary fibrosis and development of small molecules and innovative pharmaceutical formulations", image: project2 },
  { title: "Spatial lung – digital platform for spatial biology on lung tissues: biobank and transcriptomic and proteomic analysis database", image: project3 },
  { title: "Uncovering novel targets and pathways to enhance the efficacy of combination immunotherapy for lung cancer", image: project4 },
  { title: "Tissue microbiota remodeling during lung cancer progression: a fuel for immunosuppression via T-regs induction", image: project5 },
  { title: "A basket study approach in preclinical drug development: the m-Tor pathway in glioblastoma multiforme (GBM) e in non-small-cell-lung-cancer (NSCLC) tumor models.", image: project6 }
];
      ...
      <section id="about"
        ...
        <div className="cards">
          ...
          <div className="card">
            ...
            <p>We integrate Multi-Omics approaches and AI to analyze high-throughput data such as Single-Cell RNA-seq and Spatial Transcriptomics-Proteomic in order to characterize Human Lung Cancer tumor microenvironment and pulmonary fibrosis.</p>
          </div>
          <div className="card">
            <div className="card-image">
      ...
      <section id="projects" className="section light">
        ...
        <div className="projects-grid-minimal">
          {researchProjects.map((project, index) => (
            <div className="projects-card-minimal" key={index}>
              <img src={project.image} alt={project.title} className="projects-img-minimal" />
              <div className="projects-text-minimal">
                <p>{project.title}</p>
              </div>
            </div>
          ))}
